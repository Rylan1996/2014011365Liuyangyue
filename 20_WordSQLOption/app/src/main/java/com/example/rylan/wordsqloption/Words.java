...
/**
 * Created by Rylan on 2016/9/8.
 */
public class Words {
    public Words() {
    }
    public static final String AUTHORITY = "com.example.rylan.wordsqloption";
    public static abstract class Word implements BaseColumns {
        ...
        public static final String MINE_ITEM = "com.example.rylan.wprdsqloption.word";
